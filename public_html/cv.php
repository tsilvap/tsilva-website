...
<div data-aos="fade-up">
  ...
  <div class="row align-items-center">
    <div class="col-12 col-lg-4">
      <h5>
        Monitor
        <br /><small class="text-muted">Colégio Dom Jaime Câmara
          <span class="badge badge-light">Set 2017—Dez 2017</span></small>
      </h5>
    </div>
    <div class="col-12 col-lg-8">
    ...
    <div class="col-12 col-lg-4">
      <h5>
        ...
        <br /><small class="text-muted">Tractebel Energia
          <span class="badge badge-light">Ago 2015—Fev 2016</span></small>
      </h5>
    </div>
    <div class="col-12 col-lg-8">
  ...
  <div class="row">
    <div class="col-12 col-lg-4">
      <h5>
        ...
        <br /><small class="text-muted">Engenharia Elétrica (pausado)
          <span class="badge badge-light">2016—2017</span></small>
      </h5>
    </div>
    <div class="col-12 col-lg-8">
      <p>
